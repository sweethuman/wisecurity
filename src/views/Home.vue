      ...
      <v-flex lg4 xs12 pa-2>
        <v-card min-height="200px" height="100%">
          ...
          <v-card-text>
            ...
            corespunde unei categorii de lecție. Aplicațiile simple constau într-un set de teste pentru fiecare lecție.
            Fiecare test conține câte patru întrebări. Aplicațiile medii constau în două jocuri de decizie care pun
            utilizatorul într-o situație în care trebuie să folosească mai mult decât cunoștințele de bază. Aplicația
            complexă este un simulator a unei baze de date nesecurizată de unde se poate vedea ce face lipsa regulilor
            de securitate.
          </v-card-text>
        </v-card>
      </v-flex>
